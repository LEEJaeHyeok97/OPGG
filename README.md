...
api-server-spring-boot
  ...
  > src.main.java.com.example.demo
    > config
      ...
      | WebConfig.java // Spring MVC 설정 중 Web과 관련된 설정을 커스터마이징 하는 곳
    > src
      > test
      ...
      > user
        ...
        | UserService.java
        | UserDao.java
      | WebSecurityConfig.java // Spring Security 설정 (JWT 사용 및 CORS 관련 설정이 작성되어 있음)
    > utils
...
## ✨License
- 본 템플릿의 소유권은 소프트스퀘어드에 있습니다. 본 자료에 대한 상업적 이용 및 무단 복제, 배포 및 변경을 원칙적으로 금지하며 이를 위반할 때에는 형사처벌을 받을 수 있습니다.#   O P G G  
 